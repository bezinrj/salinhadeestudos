        ...
        {blocks.map((b, i) => {
          ...
          return (
            ...
            >
              ...
              {b.id === "discursivas" ? (
                /* Live 2x2 card preview */
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {discursivasCards.map((c) => (
                    <div
                      key={c.code}
                      className="rounded-2xl border border-border bg-card/70 p-4 flex flex-col"
                    >
                      <div className="flex flex-wrap items-center gap-1.5">
                        ...
                        <span className="rounded-md border border-gold/40 px-2 py-0.5 text-[10px] font-semibold text-gold">
                          {c.code}
                        </span>
                      </div>
                      <h4 className="mt-3 font-display text-sm font-bold leading-snug">
                        {c.title}
                      </h4>
