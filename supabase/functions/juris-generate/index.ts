...
const TOOL_SCHEMA = {
  ...
  properties: {
    ...
    conceitual: { type: "string", description: "Instituto jurídico — explicação didática, um por linha, em texto simples e sem Markdown" },
    ...
    principios: { type: "string", description: "NOME — descrição, um por linha, em texto simples e sem Markdown" },
    doutrina: { type: "string", description: "AUTOR — posição, um por linha, em texto simples e sem Markdown" },
    jurisprudencia: { type: "string", description: "TRIBUNAL · REF — descrição, um por linha, em texto simples e sem Markdown" },
