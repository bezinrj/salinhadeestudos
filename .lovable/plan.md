...
6. Não penalizar: ausência de citação literal de artigo quando o conteúdo da norma está correto, ordem diferente dos argumentos, estilo/redação, terminologia sinônima.
7. Continua penalizando: tese central errada, erro material de direito, conclusão contrária ao caso, omissão real de um eixo do barema.
